              ...
              <div className="mb-4">
                ...
                {baselineIntensity == null ? (
                  ...
                  <p className="text-sm text-gray-700">
                    Average early-period water intensity is{" "}
                    <span className="font-semibold">
                      {formatNumber(baselineIntensity)} m³/tonne
                    </span>
              ...
              <div className="mb-4">
                ...
                {benchmarkIntensityRaw == null ? (
                  <p className="text-xs text-gray-500">
                    ...
                    a proxy benchmark for water intensity.
                  </p>
                ) : (
                  <p className="text-sm text-gray-700">
              ...
              <div className="mb-4">
                ...
                {comparisonDelta == null ? (
                  <p className="text-xs text-gray-500">
                    ...
                    will show how far your water intensity is above or below
                    target.
                  </p>
                ) : (
                  <p className="text-sm text-gray-700">
                    Latest water intensity is{" "}
                    <span className="font-semibold">
                      {formatNumber(currentIntensity)} m³/tonne
                    </span>
                    , which is{" "}
                    <span
